...
public class Film {
	...
	public Film(int filmNr, String produsent, String filmTittel, int lanseringAar, Sjanger sjanger, String filmSelskap ) {
		this.filmNr = filmNr;
	...
	public String toString() {
	    return "Film [filmNr=" + filmNr + ", produsent=" + produsent + ", filmTittel=" + filmTittel
	            + ", lanseringAar=" + lanseringAar + ", sjanger=" + sjanger + ", filmSelskap=" + filmSelskap + "]";
	}
}
